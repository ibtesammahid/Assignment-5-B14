...
- Showing the Technology Card along with a button which will be added to technology stack by clicking.
- There is Stack which is hold the selected technology. Is also comes with deleting feature. It allows you to delete a selected technology by clicking the cross icon and can delete all the technology by clicking the remove all button.
- Responsive UI - This technology is build with responsive UI by using TailwindCSS. It will change it's UI in different size of screen.
